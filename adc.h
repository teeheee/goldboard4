/*!
 ...
 @brief      ADC driver. Maybe not the best implementation.
 TODO needs some more investigation if its the optimal solution.
...
void adc_start(uint8_t prescaler, uint8_t vref, uint8_t pin_qty,
