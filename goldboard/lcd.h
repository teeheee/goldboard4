...
It was slightly modified to use i2c Portexpander as data pins.
...
#endif
#ifndef LCD_DELAY_WRITE
#define LCD_DELAY_WRITE 400      /**< enable signal pulse width in micro seconds */
#endif
...
/**
 ...
 @param    pcf \b zeiger auf PCF8574A Obejekt das das Display steuern soll           
 @return  none
*/
extern void lcd_init(uint8_t dispAttr, PCF8574A* pcf);
